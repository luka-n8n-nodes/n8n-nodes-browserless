...
export const properties: INodeProperties[] = [
  ...
  },
  {
    ...
    description: 'Provide a JavaScript module that exports a default async function. The function runs in Browserless and can use page/context, then return a serializable object (for example, { type: "application/JSON", ... }).',
    routing: {
      request: {
        body: {
          code: '={{ $value }}',
  ...
  },
  {
    ...
    default: '{}',
    description:
      'Optional JSON object injected into your Download function as context variables',
    routing: {
      request: {
        body: {
